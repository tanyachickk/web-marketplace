    ...
    .request__body
      .request__content
        card.request__info(v-if="request")
          ...
          .request-info
            .request-info__item.customer-info
              .customer__avatar(:style="`backgroundImage: url(https://designrevision.com/demo/shards-dashboard-lite/images/avatars/0.jpg)`")
              .customer__details
                .customer__name Александр Петров
                .customer__publish-date 31.02.2012
            .request-info__item
